...
<head>
  ...
  <title>Edit Category - Local Service Search Engine</title>
  ...
  <div class="pagetitle">
	...
	<nav>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active"><a href="viewCategory.jsp">View Category</a></li>
            ...
            <div class="card">
                <div class="card-body pt-3">
                    ...
                    <%                   
						...
						CategoryDtls c =dao.getCategoryById(id);
					%>
                 			...
                 			<input type="hidden" name="id" value="<%=id%>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input type="text" name="Category" class="form-control" value="<%= c.getCategory()%>" required>
                                    </div>
                                </div>
